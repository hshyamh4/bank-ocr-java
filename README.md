...
Compile to jar with "lein uberjar"

Execute with "java -jar ./target/bank-ocr-0.1.0-SNAPSHOT-standalone.jar ./resources/accounts.txt ./resources/results.txt"

## License

Copyright © 2014 Paul Umbers
